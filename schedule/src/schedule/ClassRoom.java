...
public class ClassRoom {
	...
	private void initialize() {
		...
		lblNewLabel.setBounds(74, 84, 75, 14);
		frame.getContentPane().add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("Building Number");
		lblNewLabel_1.setBounds(74, 109, 89, 14);
		frame.getContentPane().add(lblNewLabel_1);
		
		JLabel lblTitle = new JLabel("Capacity");
		lblTitle.setBounds(74, 134, 62, 14);
		...
		JLabel lblNewLabel_2 = new JLabel("ClassRoom Edit");
